...
export const Detail: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full max-w-3xl mx-auto bg-[#F8F5E6] min-h-screen">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {activeTab === 'notes' && (
          <div className="h-full flex flex-col">
            ...
            {isNotePreview ? (
                <div className="flex-1 bg-white/30 border-l-4 border-zinc-200 pl-4 py-2 overflow-y-auto">
                    {noteEdit ? <SketchMarkdown content={noteEdit} /> : <span className="text-zinc-400 italic">No notes yet...</span>}
                </div>
            ) : (
                <>
                    <textarea
                      className="flex-1 w-full h-64 bg-transparent resize-none focus:outline-none font-hand text-xl leading-8 text-zinc-700 p-2 border-l-4 border-red-200 pl-4"
